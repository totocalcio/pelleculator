    ...
    return (
      <View style={[defaultStyles.container, { paddingHorizontal: 30 }]}>
        ...
        <Text style={[styles.text, { marginBottom: 30 }]}>
          成長期（主に4~6ヶ月くらい）はペレットも食べ放題で良いとの意見もありますが、本アプリはあくまで計算アプリなので掲載していません。「ペレット食べ放題論」が間違っているというわけではないと思いますので、うさちゃんの様子を見ながら与えてあげて下さい。
        </Text>
        <View style={styles.titleView}>
        ...
        <Text style={styles.text}>
          ...
          と表示しています。維持期のペレットの量は体重の1~3%と言われていますが、1.5%前後が良いとされていることが多いため、わかりやすく1.5%の量も表示するようにしています。
        </Text>
      </View>
    );
  }
